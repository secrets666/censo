...
class Trainer:
    ...
    def train_once(self, sst, nino_true, ratio):
        ...
        # print(sst.shape)  # (2,38,24,48,6)
        # print(sst_pred.shape)  # (2,37,2,24,48)
    ...
    def infer(self, dataset, dataloader, save_data=False):
        ...
        with torch.no_grad():
            ...
            if save_data:
                ...
                np.save('/media/ruichuang/ENSO_predict/predictedENSO/interval_7_11//CMIP5_pred_5.npy', sst_pred)
                sst_true = sst_true.to("cpu").numpy()
                print("sst_true.shape=", sst_true.shape)
                np.save('/media/ruichuang/ENSO_predict/predictedENSO/interval_7_11//CMIP5_true_5.npy', sst_true)
...
if __name__ == '__main__':
    ...
    dataset_train = cmip_dataset(sst_train, nino_train, samples_gap=5)
