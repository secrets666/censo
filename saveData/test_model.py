    ...
    def infer(self, dataset, dataloader, save_data=False):
        ...
        with torch.no_grad():
            ...
            if save_data:
                ...
                np.save('../../best_model_data/hybrid/godas/sst_pred.npy', sst_pred)
                sst_true = sst_true.to("cpu").numpy()
                print("sst_true.shape=", sst_true.shape)
                np.save('../../best_model_data/hybrid/godas/sst_true.npy', sst_true)
...
if __name__ == '__main__':
    ...
    chk = torch.load('checkpoint.chk', map_location='cuda:0')
