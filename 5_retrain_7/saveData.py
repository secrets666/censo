    ...
    def infer(self, dataset, dataloader, save_data=False):
        ...
        with torch.no_grad():
            ...
            if save_data:
                ...
                np.save('/media/ruichuang/ENSO_predict/predictedENSO/interval_5_7//CMIP5_pred_13.npy', sst_pred)
                sst_true = sst_true.to("cpu").numpy()
                print("sst_true.shape=", sst_true.shape)
                np.save('/media/ruichuang/ENSO_predict/predictedENSO/interval_5_7//CMIP5_true_13.npy', sst_true)
