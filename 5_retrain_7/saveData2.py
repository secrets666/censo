    ...
    def infer(self, dataset, dataloader, save_data=False):
        ...
        with torch.no_grad():
            ...
            if save_data:
                ...
                np.save('/media/ruichuang/ENSO_predict/predictedENSO/interval_5_7/GODAS_pred.npy', sst_pred)
                sst_true = sst_true.to("cpu").numpy()
                print("sst_true.shape=", sst_true.shape)
                np.save('/media/ruichuang/ENSO_predict/predictedENSO/interval_5_7/GODAS_true.npy', sst_true)
