    ...
    def infer(self, dataset, dataloader, save_data=False):
        ...
        with torch.no_grad():
            ...
            if save_data:
                ...
                np.save('/media/ruichuang/ENSO_predict/predictedENSO/interval_7_11//CMIP5_pred_11.npy', sst_pred)
                sst_true = sst_true.to("cpu").numpy()
                print("sst_true.shape=", sst_true.shape)
                np.save('/media/ruichuang/ENSO_predict/predictedENSO/interval_7_11//CMIP5_true_11.npy', sst_true)
